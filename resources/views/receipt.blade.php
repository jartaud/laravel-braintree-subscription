...
<div class="container">
    <table style="margin-left: auto; margin-right: auto" width="550">
        ...
        <tr valign="top">
            ...
            <td>
                <br><br>
                <strong>{{ __('To') }}:</strong> {{ $owner->email ?: $owner->name }}
                <br>
            ...
            <td>
                ...
                <table width="100%" class="table" border="0">
                    ...
                    <tr>
                        <td>
                            @if ($invoice->planId)
                                {{ __('Subscription To') }} "{{ $invoice->planId }}"
                    ...
                    @if ($invoice->hasAddOn())
                        <tr>
                            <td>{{ __('Add-Ons') }} ({{ implode(', ', $invoice->addOns()) }})</td>
                            <td>{{ $invoice->addOn() }}</td>
                        </tr>
                    @endif
                    ...
                    @if ($invoice->hasDiscount())
                        <tr>
                            <td>{{ __('Discounts') }} ({{ implode(', ', $invoice->coupons()) }})</td>
