...
class Subscription extends Model
{
    ...
    {
        $model = config('laravel-braintree-subscription.model');
    ...
    public function active()
    {
        return (is_null($this->ends_at) || $this->onGracePeriod()) &&
            $this->braintree_status !== BraintreeSubscription::PENDING &&
            $this->braintree_status !== BraintreeSubscription::EXPIRED &&
    ...
    public function swap($plan)
    {
        ...
        if ($response->success) {
            ...
            throw new Exception(__('Braintree failed to swap plans') . ': ' . $response->message);
        }
     ...
     *
     * @param  \Braintree\Plan  $plan
     * @return \Jartaud\LaravelBraintreeSubscription\Subscription
     * @throws \Exception
     */
    ...
    {
        if (! $this->active()) {
            throw new InvalidArgumentException(__('Unable to apply coupon. Subscription not active.'));
        }
